...
enum CustomTimePickerEntryMode {
...
class _TimePickerModel extends InheritedModel<_TimePickerAspect> {
  ...
  final CustomTimePickerEntryMode entryMode;
  ...
  static CustomTimePickerEntryMode entryModeOf(BuildContext context) =>
...
class _HourMinuteControl extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    switch (_TimePickerModel.entryModeOf(context)) {
      case CustomTimePickerEntryMode.dial:
      case CustomTimePickerEntryMode.dialOnly:
        height = defaultTheme.hourMinuteSize.height;
      case CustomTimePickerEntryMode.input:
      case CustomTimePickerEntryMode.inputOnly:
...
typedef EntryModeChangeCallback = void Function(CustomTimePickerEntryMode);
...
/// [Navigator.pop].
///
/// Use [customShowTimePicker] to show a dialog already containing a [CustomTimePickerDialog].
class CustomTimePickerDialog extends StatefulWidget {
  ...
  const CustomTimePickerDialog({
    ...
    this.restorationId,
    this.initialEntryMode = CustomTimePickerEntryMode.dial,
    this.orientation,
  ...
  final CustomTimePickerEntryMode initialEntryMode;
...
class _CustomTimePickerDialogState extends State<CustomTimePickerDialog>
    with RestorationMixin {
  late final RestorableEnum<CustomTimePickerEntryMode> _entryMode =
      RestorableEnum<CustomTimePickerEntryMode>(widget.initialEntryMode,
          values: CustomTimePickerEntryMode.values);
  late final RestorableTimeOfDay _selectedTime =
  ...
  void _handleEntryModeChanged(CustomTimePickerEntryMode value) {
  ...
  void _toggleEntryMode() {
    switch (_entryMode.value) {
      case CustomTimePickerEntryMode.dial:
        _handleEntryModeChanged(CustomTimePickerEntryMode.input);
      case CustomTimePickerEntryMode.input:
        _handleEntryModeChanged(CustomTimePickerEntryMode.dial);
      case CustomTimePickerEntryMode.dialOnly:
      case CustomTimePickerEntryMode.inputOnly:
  ...
  void _handleOk() {
    if (_entryMode.value == CustomTimePickerEntryMode.input ||
        _entryMode.value == CustomTimePickerEntryMode.inputOnly) {
  ...
  Widget build(BuildContext context) {
    ...
    final Widget actions = Padding(
      ...
      child: Row(
        children: <Widget>[
          if (_entryMode.value == CustomTimePickerEntryMode.dial ||
              _entryMode.value == CustomTimePickerEntryMode.input)
            IconButton(
              ...
              icon: Icon(_entryMode.value == CustomTimePickerEntryMode.dial
                  ? Icons.keyboard_outlined
                  : Icons.access_time),
              tooltip: _entryMode.value == CustomTimePickerEntryMode.dial
    ...
    return Dialog(
      ...
      insetPadding: EdgeInsets.symmetric(
        horizontal: 16,
        vertical: (_entryMode.value == CustomTimePickerEntryMode.input ||
                _entryMode.value == CustomTimePickerEntryMode.inputOnly)
            ? 0
            : 24,
      ),
...
class _TimePicker extends StatefulWidget {
  ...
  const _TimePicker({
    ...
    this.minuteLabelText,
    this.restorationId,
    this.entryMode = CustomTimePickerEntryMode.dial,
    this.orientation,
    this.onEntryModeChanged,
  });
  ...
  /// when the [entryMode] is [CustomTimePickerEntryMode.dial], and
  /// [MaterialLocalizations.timePickerInputHelpText] when the [entryMode] is
  /// [CustomTimePickerEntryMode.input].
  final String? helpText;
...
class _TimePickerState extends State<_TimePicker> with RestorationMixin {
  ...
  void _setEntryMode(CustomTimePickerEntryMode mode) {
  ...
  void _handleEntryModeToggle() {
    setState(() {
      CustomTimePickerEntryMode newMode = widget.entryMode;
      switch (widget.entryMode) {
        case CustomTimePickerEntryMode.dial:
          newMode = CustomTimePickerEntryMode.input;
        case CustomTimePickerEntryMode.input:
          _autofocusHour.value = false;
          _autofocusMinute.value = false;
          newMode = CustomTimePickerEntryMode.dial;
        case CustomTimePickerEntryMode.dialOnly:
        case CustomTimePickerEntryMode.inputOnly:
...
Future<TimeOfDay?> customShowTimePicker({
  ...
  CustomTimePickerEntryMode initialEntryMode = CustomTimePickerEntryMode.dial,
  String? cancelText,
  String? confirmText,
  String? helpText,
